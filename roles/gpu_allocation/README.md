...
Validates available GPU capacity, creates GPU allocation for a tenant, and verifies the allocation is active.
...
- hosts: localhost
  roles:
    - role: stevefulme1.nvidia_ai_factory.gpu_allocation
      vars:
