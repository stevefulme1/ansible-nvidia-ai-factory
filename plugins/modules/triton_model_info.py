...
"""Ansible module for querying Triton Inference Server models resources."""
...
short_description: List or get Triton Inference Server models
description:
    - Retrieve information about Triton Inference Server models.
...
def main():
    ...
    if params.get("model_name"):
        url = f"{base_url}/api/v1/triton/models/{params['model_name']}"
        try:
