...
description:
    - Deploy, update, and remove NeMo models on NVIDIA AI infrastructure. Supports model deployment with Triton Inference Server backend.
...
- name: Create a nemo model
  stevefulme1.nvidia_ai_factory.nemo_model:
...
RETURN = r"""
model:
    description: Details of the nemo model resource.
...
def main():
    module = AnsibleModule(
        ...
        required_if=[
            ("state", "present", ("name", "model_path", "cluster_id",), True),
        ],
    )
