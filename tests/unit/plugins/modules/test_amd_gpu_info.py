...
"""Unit tests for amd_gpu_info module."""
...
class TestMissingRequests:
    ...
    def test_missing_requests_fails(self, mock_module):
        ...
        with patch(
            "ansible_collections.stevefulme1.gpu_ai_factory.plugins.modules.amd_gpu_info.HAS_REQUESTS",
            False,
        ):
            from ansible_collections.stevefulme1.gpu_ai_factory.plugins.modules import amd_gpu_info
            import importlib
            importlib.reload(amd_gpu_info)
            with patch("ansible_collections.stevefulme1.gpu_ai_factory.plugins.modules.amd_gpu_info.HAS_REQUESTS", False):
...
class TestGet:
    ...
    @patch("ansible_collections.stevefulme1.gpu_ai_factory.plugins.modules.amd_gpu_info.requests")
