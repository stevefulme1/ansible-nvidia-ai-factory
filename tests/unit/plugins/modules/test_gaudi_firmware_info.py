...
"""Unit tests for gaudi_firmware_info module."""
...
class TestMissingRequests:
    ...
    def test_missing_requests_fails(self, mock_module):
        ...
        with patch(
            "ansible_collections.stevefulme1.gpu_ai_factory.plugins.modules.gaudi_firmware_info.HAS_REQUESTS",
            False,
        ):
            from ansible_collections.stevefulme1.gpu_ai_factory.plugins.modules import gaudi_firmware_info
            import importlib
            importlib.reload(gaudi_firmware_info)
            with patch("ansible_collections.stevefulme1.gpu_ai_factory.plugins.modules.gaudi_firmware_info.HAS_REQUESTS", False):
                with pytest.raises(AnsibleFailJson) as exc_info:
                    gaudi_firmware_info.main()
...
class TestGet:
    ...
    @patch("ansible_collections.stevefulme1.gpu_ai_factory.plugins.modules.gaudi_firmware_info.requests")
