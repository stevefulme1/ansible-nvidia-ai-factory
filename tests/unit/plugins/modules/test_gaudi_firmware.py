...
"""Unit tests for gaudi_firmware module."""
...
class TestMissingRequests:
    ...
    def test_missing_requests_fails(self, mock_module):
        ...
        with patch(
            "ansible_collections.stevefulme1.gpu_ai_factory.plugins.modules.gaudi_firmware.HAS_REQUESTS",
            False,
        ):
            from ansible_collections.stevefulme1.gpu_ai_factory.plugins.modules import gaudi_firmware
            import importlib
            importlib.reload(gaudi_firmware)
            with patch("ansible_collections.stevefulme1.gpu_ai_factory.plugins.modules.gaudi_firmware.HAS_REQUESTS", False):
...
class TestGet:
    ...
    @patch("ansible_collections.stevefulme1.gpu_ai_factory.plugins.modules.gaudi_firmware.requests")
